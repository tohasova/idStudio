(() => {
    ...
    menuLinks.forEach((function(link) {
        link.addEventListener("click", (function(event) {
            ...
            if (parent) if (parent.classList.contains("_active")) parent.classList.remove("_active"); else {
                menuLinks.forEach((function(link) {
                    var linkParent = link.parentElement;
                    if (linkParent) linkParent.classList.remove("_active");
                }));
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) {
            ...
            if (iconMenu) {
                ...
                iconMenu.addEventListener("click", debouncedClick);
            }
        }
    }
    function menuClose() {
